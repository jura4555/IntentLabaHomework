...
public class Main {
    ...
    private static void testLinkedListImplFunctionality(){
        ...
        System.out.println("Масив: " + li.toString());
        System.out.println("Видалення першого елемента: " + li.removeFirst());
        System.out.println("Масив після видалення першого елемента: " + li.toString());

        System.out.println("Видалення останнього елемента: " + li.removeLast());
        System.out.println("Масив після видалення останнього елемента: " + li.toString());

        System.out.println("Видалення середнього елемента по значенню: " + li.remove("Middle1"));
        System.out.println("Масив після видалення середнього елемента: " + li.toString());
        ...
        li.clear();
        System.out.println("Очищення масиву: " + li.toString());
    }
}
